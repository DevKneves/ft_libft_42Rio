...
memcmp		| ft_striteri	|	
strlen		| ft_strmapi	|
strdup		| ft_putchar_fd   | ft_strnchr
strcpy		| ft_putstr_fd    |
strncpy		| ft_putendl_fd   |
strcat		| ft_putnbr_fd    |
strlcat		| 	| |
strchr		| 	| |
strrchr		|         	  |
strstr		| 		  | |
strnstr		|  | ft_putnstr
strcmp		|  | ft_strreplace
strncmp		| 	| | ft_isemptystr
atoi		| 		| | ft_strsplitall
isalpha		| 	| | ft_countwordsall
isdigit		| 	| | ft_freestrarr
isalnum		| | | ft_strjoincl
isascii		| 	| | ft_strjoinchcl
...
To create that library, after downloading/cloning this project, **cd** into the project, copy all the files from the sub folders to the root directory and finally, call make:
	...
	git clone https://github.com/DevKneves/libft-42Rio
	cd libft-42Rio
	make
...
2. Clone this repo (don't name it libft) and copy the Makefile-sample as Makefile and libft.h to your own project:
		...
		git clone https://github.com/DevKneves/libft r4-libft
...
* [get_next_line](https://github.com/DevKneves/Get-Next-Line-42Rio)
* [Pipex](https://github.com/DevKneves/pipex-42rio)
